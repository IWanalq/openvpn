...
```bash
#####curl -O https://raw.githubusercontent.com/IWanalq/openvpn-install/master/openvpn-install.sh可能失效
curl -O https://github.com/IWanalq/openvpn/blob/master/openvpn-install.sh
